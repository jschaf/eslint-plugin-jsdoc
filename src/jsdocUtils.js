...
const isValidTag = (name : string, additionalTagNames : Array<string>) : boolean => {
    const validTagNames = _.keys(tagNames)
          .concat(_.flatten(_.values(tagNames)))
          .concat(additionalTagNames);
